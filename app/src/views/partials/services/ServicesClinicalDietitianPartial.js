                        ...
                        <Box className='service-description'>
                            ...
                            <Box marginBottom={3}>
                                ...
                                <Box className='card-wrapper team page'>
                                    {width >= 991.98 ? (
                                        team.filter(item => item.services.includes('clinicalDietitian')).map((item, index) => (
                                            <CardTeam2
                                                key={index}
...
export default Page(ServicesClinicalDietitianPartial);
