...
import { team, agataSkwerekSzewczyk } from '../../../data/team';

const TeamAgataSkwerekSzewczykPartial = () => {
    ...
    const teamCopy = [ ...team ];
    const agataSkwerekSzewczykCopy = [{ ...agataSkwerekSzewczyk }];
                ...
                <Box className='view-body'>
                    <Container className='body-wrapper team'>
                        <Box className='team-details'>
                            {agataSkwerekSzewczykCopy.map((item, index) => (
                                <Box key={index}>
                        ...
                        <Box className='team-proposed'>
                            <Box className='card-wrapper team-proposed'>
                                {teamCopy.filter(item => item.designation !== 'agataSkwerekSzewczyk').slice(0, 8).map((item, index) => (
                                    <CardTeamProposed2
                                        key={index}
                                        cardTitle={item.name}
...
export default Page(TeamAgataSkwerekSzewczykPartial);
