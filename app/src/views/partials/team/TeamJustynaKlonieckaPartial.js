...
import { team, justynaKloniecka } from '../../../data/team';

const TeamJustynaKlonieckaPartial = () => {
    ...
    const teamCopy = [ ...team ];
    const justynaKlonieckaCopy = [{ ...justynaKloniecka }];
                ...
                <Box className='view-body'>
                    <Container className='body-wrapper team'>
                        <Box className='team-details'>
                            {justynaKlonieckaCopy.map((item, index) => (
                                <Box key={index}>
                        ...
                        <Box className='team-proposed'>
                            <Box className='card-wrapper team-proposed'>
                                {teamCopy.filter(item => item.designation !== 'justynaKloniecka').slice(0, 8).map((item, index) => (
                                    <CardTeamProposed2
                                        key={index}
                                        cardTitle={item.name}
...
export default Page(TeamJustynaKlonieckaPartial);
