...
import { team, konradKochan } from '../../../data/team';

const TeamKonradKochanPartial = () => {
    ...
    const teamCopy = [ ...team ];
    const konradKochanCopy = [{ ...konradKochan }];
                    ...
                    <Container className='body-wrapper team'>
                        ...
                        <Box className='team-proposed'>
                            <Box className='card-wrapper team-proposed'>
                                {teamCopy.filter(item => item.designation !== 'konradKochan').slice(0, 8).map((item, index) => (
                                    <CardTeamProposed2
                                        key={index}
                                        cardTitle={item.name}
...
export default Page(TeamKonradKochanPartial);
