...
import { team, paulinaBudna } from '../../../data/team';

const TeamPaulinaBudnaPartial = () => {
    ...
    const teamCopy = [ ...team ];
    const paulinaBudnaCopy = [{ ...paulinaBudna }];
                    ...
                    <Container className='body-wrapper team'>
                        ...
                        <Box className='team-proposed'>
                            <Box className='card-wrapper team-proposed'>
                                {teamCopy.filter(item => item.designation !== 'paulinaBudna').slice(0, 8).map((item, index) => (
                                    <CardTeamProposed2
                                        key={index}
                                        cardTitle={item.name}
...
export default Page(TeamPaulinaBudnaPartial);
