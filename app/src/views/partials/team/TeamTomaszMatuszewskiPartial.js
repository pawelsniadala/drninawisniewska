...
import { team, tomaszMatuszewski } from '../../../data/team';

const TeamTomaszMatuszewskiPartial = () => {
    ...
    const teamCopy = [ ...team ];
    const tomaszMatuszewskiCopy = [{ ...tomaszMatuszewski }];
                ...
                <Box className='view-body'>
                    <Container className='body-wrapper team'>
                        <Box className='team-details'>
                            {tomaszMatuszewskiCopy.map((item, index) => (
                                <Box key={index}>
                        ...
                        <Box className='team-proposed'>
                            <Box className='card-wrapper team-proposed'>
                                {teamCopy.filter(item => item.designation !== 'tomaszMatuszewski').slice(0, 8).map((item, index) => (
                                    <CardTeamProposed2
                                        key={index}
                                        cardTitle={item.name}
...
export default Page(TeamTomaszMatuszewskiPartial);
