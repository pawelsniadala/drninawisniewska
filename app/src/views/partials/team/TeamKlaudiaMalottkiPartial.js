...
import { team, klaudiaMalottki } from '../../../data/team';

const TeamKlaudiaMalottkiPartial = () => {
    ...
    const teamCopy = [ ...team ];
    const klaudiaMalottkiCopy = [{ ...klaudiaMalottki }];
                ...
                <Box className='view-body'>
                    <Container className='body-wrapper team'>
                        <Box className='team-details'>
                            {klaudiaMalottkiCopy.map((item, index) => (
                                <Box key={index}>
                        ...
                        <Box className='team-proposed'>
                            <Box className='card-wrapper team-proposed'>
                                {teamCopy.filter(item => item.designation !== 'klaudiaMalottki').slice(0, 8).map((item, index) => (
                                    <CardTeamProposed2
                                        key={index}
                                        cardTitle={item.name}
...
export default Page(TeamKlaudiaMalottkiPartial);
