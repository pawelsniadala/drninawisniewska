...
import { team, aleksandraGorczynska } from '../../../data/team';

const TeamAleksandraGorczynskaPartial = () => {
    ...
    const teamCopy = [ ...team ];
    const aleksandraGorczynskaCopy = [{ ...aleksandraGorczynska }];
                ...
                <Box className='view-body'>
                    <Container className='body-wrapper team'>
                        <Box className='team-details'>
                            {aleksandraGorczynskaCopy.map((item, index) => (
                                <Box key={index}>
...
export default Page(TeamAleksandraGorczynskaPartial);
