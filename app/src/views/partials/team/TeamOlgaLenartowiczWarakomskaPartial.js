...
import { team, olgaLenartowiczWarakomska } from '../../../data/team';

const TeamOlgaLenartowiczWarakomskaPartial = () => {
    ...
    const teamCopy = [ ...team ];
    const olgaLenartowiczWarakomskaCopy = [{ ...olgaLenartowiczWarakomska }];
                        ...
                        <Box className='nav-wrapper'>
                            ...
                            >
                                ...
                                <Typography color='text.primary'>
                                    {olgaLenartowiczWarakomska.name}
                                </Typography>
                            </Breadcrumbs>
                        </Box>
                ...
                <Box className='view-body'>
                    <Container className='body-wrapper team'>
                        <Box className='team-details'>
                            {olgaLenartowiczWarakomskaCopy.map((item, index) => (
                                <Box key={index}>
                        ...
                        <Box className='team-proposed'>
                            <Box className='card-wrapper team-proposed'>
                                {teamCopy.filter(item => item.designation !== 'olgaLenartowiczWarakomska').slice(0, 8).map((item, index) => (
                                    <CardTeamProposed
