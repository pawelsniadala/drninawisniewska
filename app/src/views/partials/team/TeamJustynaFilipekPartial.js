...
import { team, justynaFilipek } from '../../../data/team';

const TeamJustynaFilipekPartial = () => {
    ...
    const teamCopy = [ ...team ];
    const justynaFilipekCopy = [{ ...justynaFilipek }];
                ...
                <Box className='view-body'>
                    <Container className='body-wrapper team'>
                        <Box className='team-details'>
                            {justynaFilipekCopy.map((item, index) => (
                                <Box key={index}>
                        ...
                        <Box className='team-proposed'>
                            <Box className='card-wrapper team-proposed'>
                                {teamCopy.filter(item => item.designation !== 'justynaFilipek').slice(0, 8).map((item, index) => (
                                    <CardTeamProposed2
                                        key={index}
                                        cardTitle={item.name}
...
export default Page(TeamJustynaFilipekPartial);
