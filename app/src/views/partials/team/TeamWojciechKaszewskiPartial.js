...
const TeamWojciechKaszewskiPartial = () => {
    ...
    const teamCopy = [ ...team ];
    const wojciechKaszewskiCopy = [{ ...wojciechKaszewski }];
                ...
                <Box className='view-body'>
                    <Container className='body-wrapper team'>
                        <Box className='team-details'>
                            {wojciechKaszewskiCopy.map((item, index) => (
                                <Box key={index}>
...
export default Page(TeamWojciechKaszewskiPartial);
