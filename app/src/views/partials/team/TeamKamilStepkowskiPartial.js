...
import { team, kamilStepkowski } from '../../../data/team';

const TeamKamilStepkowskiPartial = () => {
    ...
    const teamCopy = [ ...team ];
    const kamilStepkowskiCopy = [{ ...kamilStepkowski }];
                ...
                <Box className='view-body'>
                    <Container className='body-wrapper team'>
                        <Box className='team-details'>
                            {kamilStepkowskiCopy.map((item, index) => (
                                <Box key={index}>
                        ...
                        <Box className='team-proposed'>
                            <Box className='card-wrapper team-proposed'>
                                {teamCopy.filter(item => item.designation !== 'kamilStepkowski').slice(0, 8).map((item, index) => (
                                    <CardTeamProposed2
                                        key={index}
                                        cardTitle={item.name}
...
export default Page(TeamKamilStepkowskiPartial);
