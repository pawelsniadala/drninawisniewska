...
const TeamKatarzynaZbronskaPartial = () => {
    ...
    const teamCopy = [ ...team ];
    const katarzynaZbronskaCopy = [{ ...katarzynaZbronska }];
                ...
                <Box className='view-body'>
                    <Container className='body-wrapper team'>
                        <Box className='team-details'>
                            {katarzynaZbronskaCopy.map((item, index) => (
                                <Box key={index}>
...
export default Page(TeamKatarzynaZbronskaPartial);
