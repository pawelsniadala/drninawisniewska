...
import { team, paulinaTatara } from '../../../data/team';

const TeamPaulinaTataraPartial = () => {
    ...
    const teamCopy = [ ...team ];
    const paulinaTataraCopy = [{ ...paulinaTatara }];
                ...
                <Box className='view-body'>
                    <Container className='body-wrapper team'>
                        <Box className='team-details'>
                            {paulinaTataraCopy.map((item, index) => (
                                <Box key={index}>
                        ...
                        <Box className='team-proposed'>
                            <Box className='card-wrapper team-proposed'>
                                {teamCopy.filter(item => item.designation !== 'paulinaTatara').slice(0, 8).map((item, index) => (
                                    <CardTeamProposed2
                                        key={index}
                                        cardTitle={item.name}
...
export default Page(TeamPaulinaTataraPartial);
