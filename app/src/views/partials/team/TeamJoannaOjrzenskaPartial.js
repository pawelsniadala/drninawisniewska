...
import { team, joannaOjrzenska } from '../../../data/team';

const TeamJoannaOjrzenskaPartial = () => {
    ...
    const teamCopy = [ ...team ];
    const joannaOjrzenskaCopy = [{ ...joannaOjrzenska }];
                ...
                <Box className='view-body'>
                    <Container className='body-wrapper team'>
                        <Box className='team-details'>
                            {joannaOjrzenskaCopy.map((item, index) => (
                                <Box key={index}>
                        ...
                        <Box className='team-proposed'>
                            <Box className='card-wrapper team-proposed'>
                                {teamCopy.filter(item => item.designation !== 'joannaOjrzenska').slice(0, 8).map((item, index) => (
                                    <CardTeamProposed2
                                        key={index}
                                        cardTitle={item.name}
...
export default Page(TeamJoannaOjrzenskaPartial);
