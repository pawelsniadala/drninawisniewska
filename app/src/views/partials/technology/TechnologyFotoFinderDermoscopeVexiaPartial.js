                        ...
                        <Box className='technology-description'>
                            <Box marginBottom={3}>
                                <Typography className='paragraph'>
                                    FotoFinder <strong>dermoscope vexia</strong> jest wszechstronnym systemem wyposażonym w kamerę <strong>medicam®</strong> 1000 (do wyboru z obiektywem D-Scope IV). Jest mocnym wsparciem w postawieniu diagnozy, zachęca pacjentów do regularnych kontroli, a co najważniejsze chroni przed niepotrzebnym wycinaniem znamion.
                                </Typography>
                                ...
                                <Typography className='paragraph'>
                                    Opcjonalnie, system może być wyposażony w programy eksperckie, takie jak Mole<strong>analyzer</strong>® (automatyczna ocena znamion), czy Tricho<strong>scale pro</strong>® (automatyczna ocena trichoskopowa).
                                </Typography>
                            </Box>
                        </Box>
