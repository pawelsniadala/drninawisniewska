...
const Table1 = () => {
    ...
    const rows = [
        createData('Konsultacja kardiologiczna - lek. med. Michał Radzio', 280),
        createData('ECHO serca', 300),
...
export default PricesCardiologyPartial;
