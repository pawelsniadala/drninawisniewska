...
const TreatmentToksynaBotulinowaPartial = () => {
    ...
    const filteredSpecialists = team.filter(item => item.treatment.includes('toksyna-botulinowa'))
    ...
    const filteredTreatments = treatment.filter(item => item.specialization.includes('aesthetic-medicine')).filter(item => item.treatment !== 'toksyna-botulinowa');
    ...
    const filteredEffects = toksynaBotulinowa.effects;
