...
const TreatmentBadanieZnamionBarwnikowychPartial = () => {
  ...
  const treatmentSpecialists = team.filter((item) =>
    item.treatment?.includes("badanie-znamion-barwnikowych"),
  );
  ...
  const otherDermatologyTreatments = treatment.filter(
    (item) =>
      ...
      item.treatment !== "badanie-znamion-barwnikowych",
  );
  ...
  return (
    <>
      <Seo
        ...
        description="Badanie znamion barwnikowych w Klinice dr Niny Wiśniewskiej w Wyszkowie obejmuje ocenę zmian skórnych dermatoskopem lub wideodermatoskopem."
        path="/zabiegi/dermatologia/badanie-znamion-barwnikowych"
        image={badanieZnamionBarwnikowych.images[0]?.src}
            ...
            <Container className="body-wrapper treatment-details">
              ...
              <Box className="proposed-wrapper">
                <Box className="box-proposed">
                  ...
                  <Box
                    id="badanie-znamion-specialists-list"
                    ...
                    {treatmentSpecialists.length > 3 && (
                      <Fade in>
                        <Button
                          ...
                          aria-controls="badanie-znamion-specialists-list"
                          endIcon={
                            showMoreSpecialists ? (
                              <KeyboardArrowUpIcon
                                aria-hidden="true"
