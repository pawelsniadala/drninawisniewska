...
export const modelowanieUst = {
  ...
  specialist: ["klaudia-malottki", "olga-lenartowicz-warakomska"],
};
...
export const stymulatoryTkankowe = {
  ...
  description:
    "Stymulatory tkankowe to substancje lub techniki stosowane w medycynie w celu pobudzenia wzrostu, regeneracji lub funkcjonowania tkanek. Mają one na celu wspomaganie procesów naprawczych organizmu i stymulowanie go do regeneracji uszkodzonych tkanek.",
  info: "Zdjęcie ukazuje efekt zabiegu u konkretnego pacjenta. Efekt zabiegu może się różnić w zależności od indywidualnych cech pacjneta, liczby powtórzeń zabiegu, stosowania się pacjenta do zaleceń pozabiegowych oraz umiejętności i doświadczenia osoby przeprowadzającej zabieg.",
...
export const laserFrakcyjny = {
  ...
  description:
    "Laser frakcyjny jest idealnym i sprawdzonym rozwiązaniem znajdującym zastosowanie w wielu dziedzinach medycyny. Laser pozwala na osiągnięcie bardzo dobrych efektów zabiegowych w postaci likwidacji blizn potrądzikowych, poprawy jakości skóry i wytworzenia nowych struktur kolagenu.",
  info: "Zdjęcie ukazuje efekt zabiegu u konkretnego pacjenta. Efekt zabiegu może się różnić w zależności od indywidualnych cech pacjneta, liczby powtórzeń zabiegu, stosowania się pacjenta do zaleceń pozabiegowych oraz umiejętności i doświadczenia osoby przeprowadzającej zabieg.",
...
export const sonoQueenTechnologiaHifu = {
  ...
  description:
    "SonoQueen to nowoczesna technologia wykorzystująca moc HIFU. Najnowsza generacja technologii HIFU (High Intensity Focused Ultrasound) to sfokusowane ultradźwięki o wysokiej częstotliwości do bezinwazyjnego, niechirurgicznego liftingu twarzy i ciała.",
  info: "Zdjęcie ukazuje efekt zabiegu u konkretnego pacjenta. Efekt zabiegu może się różnić w zależności od indywidualnych cech pacjneta, liczby powtórzeń zabiegu, stosowania się pacjenta do zaleceń pozabiegowych oraz umiejętności i doświadczenia osoby przeprowadzającej zabieg.",
...
export const peelingMedyczny = {
  ...
  specialist: ["paulina-sot", "karolina-rakowska"],
...
export const badanieAdos2 = {
  ...
  description:
    "Badanie Ados-2 dla dzieci, młodzieży i osób dorosłych. Pomaga wykryć  spektrum autyzmu (Zespół Aspergera,  spektrum autyzmu) u dzieci od 12 miesiąca życia, ale także u młodzieży i u dorosłych.",
  info: "Zdjęcie ukazuje efekt zabiegu u konkretnego pacjenta. Efekt zabiegu może się różnić w zależności od indywidualnych cech pacjneta, liczby powtórzeń zabiegu, stosowania się pacjenta do zaleceń pozabiegowych oraz umiejętności i doświadczenia osoby przeprowadzającej zabieg.",
