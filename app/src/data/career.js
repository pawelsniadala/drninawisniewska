...
export const getCareerOfferBySlug = (slug) =>
  allCareerOffers.find((item) => item.slug === slug);
...
export const application = {
  recruitment: [
    ...
    },
    {
      ...
      description:
        "Następnie spotkasz się z jednym z naszych rekruterów, aby lepiej się poznać.",
    },
    {
